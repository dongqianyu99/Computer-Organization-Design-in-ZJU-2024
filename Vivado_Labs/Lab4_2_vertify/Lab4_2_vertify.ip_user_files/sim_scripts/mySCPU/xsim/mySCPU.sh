...
#
# Script generated by Vivado on Thu Dec 05 22:00:10 +0800 2024
...
#
# Usage        : mySCPU.sh
#                mySCPU.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                mySCPU.sh [-reset_run]
#                mySCPU.sh [-reset_log]
#                mySCPU.sh [-help]
#
...
# script info
echo -e "mySCPU.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./mySCPU.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot mySCPU xil_defaultlib.mySCPU xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim mySCPU -key {Behavioral:sim_1:Functional:mySCPU} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mySCPU.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./mySCPU.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: mySCPU.sh [-help]\n\
Usage: mySCPU.sh [-step]\n\
Usage: mySCPU.sh [-lib_map_path]\n\
Usage: mySCPU.sh [-reset_run]\n\
Usage: mySCPU.sh [-reset_log]\n\
Usage: mySCPU.sh [-keep_index]\n\
Usage: mySCPU.sh [-noclean_files]\n\n\
