...
#
# Script generated by Vivado on Mon Dec 02 22:44:29 +0800 2024
...
#
# Usage        : MUX4T1.sh
#                MUX4T1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                MUX4T1.sh [-reset_run]
#                MUX4T1.sh [-reset_log]
#                MUX4T1.sh [-help]
#
...
# script info
echo -e "MUX4T1.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./MUX4T1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot MUX4T1 xil_defaultlib.MUX4T1 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim MUX4T1 -key {Behavioral:sim_1:Functional:MUX4T1} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb MUX4T1.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./MUX4T1.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: MUX4T1.sh [-help]\n\
Usage: MUX4T1.sh [-step]\n\
Usage: MUX4T1.sh [-lib_map_path]\n\
Usage: MUX4T1.sh [-reset_run]\n\
Usage: MUX4T1.sh [-reset_log]\n\
Usage: MUX4T1.sh [-keep_index]\n\
Usage: MUX4T1.sh [-noclean_files]\n\n\
