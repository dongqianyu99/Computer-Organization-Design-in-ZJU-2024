...
#
# Script generated by Vivado on Mon Sep 23 21:58:29 +0800 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : ROM_B_32.sh
...
#
# Usage        : ROM_B_32.sh
#                ROM_B_32.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ROM_B_32.sh [-reset_run]
#                ROM_B_32.sh [-reset_log]
#                ROM_B_32.sh [-help]
#
...
# script info
echo -e "ROM_B_32.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ROM_B_32.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L dist_mem_gen_v8_0_14 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ROM_B_32 xil_defaultlib.ROM_B_32 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ROM_B_32 -key {Behavioral:sim_1:Functional:ROM_B_32} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ROM_B_32.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ROM_B_32.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ROM_B_32.sh [-help]\n\
Usage: ROM_B_32.sh [-step]\n\
Usage: ROM_B_32.sh [-lib_map_path]\n\
Usage: ROM_B_32.sh [-reset_run]\n\
Usage: ROM_B_32.sh [-reset_log]\n\
Usage: ROM_B_32.sh [-keep_index]\n\
Usage: ROM_B_32.sh [-noclean_files]\n\n\
