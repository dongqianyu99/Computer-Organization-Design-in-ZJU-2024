...
#
# Script generated by Vivado on Mon Sep 23 21:59:52 +0800 2024
...
#
# Usage        : MIO_BUS_0.sh
#                MIO_BUS_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                MIO_BUS_0.sh [-reset_run]
#                MIO_BUS_0.sh [-reset_log]
#                MIO_BUS_0.sh [-help]
#
...
#                script (type 'MIO_BUS_0.sh -help' for more information).
#
...
# script info
echo -e "MIO_BUS_0.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./MIO_BUS_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.MIO_BUS_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.MIO_BUS_0 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log MIO_BUS_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: MIO_BUS_0.sh [-step]\n\
Usage: MIO_BUS_0.sh [-lib_map_path]\n\
Usage: MIO_BUS_0.sh [-reset_run]\n\
Usage: MIO_BUS_0.sh [-reset_log]\n\
Usage: MIO_BUS_0.sh [-keep_index]\n\
