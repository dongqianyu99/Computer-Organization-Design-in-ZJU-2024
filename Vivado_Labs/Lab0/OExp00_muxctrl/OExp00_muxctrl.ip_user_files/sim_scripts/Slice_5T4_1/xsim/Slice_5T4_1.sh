...
#
# Script generated by Vivado on Wed Sep 11 19:58:25 +0800 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : Slice_5T4_1.sh
...
#
# Usage        : Slice_5T4_1.sh
#                Slice_5T4_1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Slice_5T4_1.sh [-reset_run]
#                Slice_5T4_1.sh [-reset_log]
#                Slice_5T4_1.sh [-help]
#
...
# script info
echo -e "Slice_5T4_1.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Slice_5T4_1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot Slice_5T4_1 xil_defaultlib.Slice_5T4_1 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim Slice_5T4_1 -key {Behavioral:sim_1:Functional:Slice_5T4_1} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Slice_5T4_1.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./Slice_5T4_1.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: Slice_5T4_1.sh [-help]\n\
Usage: Slice_5T4_1.sh [-step]\n\
Usage: Slice_5T4_1.sh [-lib_map_path]\n\
Usage: Slice_5T4_1.sh [-reset_run]\n\
Usage: Slice_5T4_1.sh [-reset_log]\n\
Usage: Slice_5T4_1.sh [-keep_index]\n\
Usage: Slice_5T4_1.sh [-noclean_files]\n\n\
