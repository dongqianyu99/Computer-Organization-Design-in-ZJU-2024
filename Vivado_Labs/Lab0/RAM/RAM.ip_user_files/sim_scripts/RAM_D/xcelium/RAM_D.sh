...
#
# Script generated by Vivado on Tue Sep 10 15:30:10 +0800 2024
...
#
# Usage        : RAM_D.sh
#                RAM_D.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                RAM_D.sh [-reset_run]
#                RAM_D.sh [-reset_log]
#                RAM_D.sh [-help]
#
...
#                script (type 'RAM_D.sh -help' for more information).
#
...
# script info
echo -e "RAM_D.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./RAM_D.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.RAM_D xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.RAM_D -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log RAM_D_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: RAM_D.sh [-reset_log]\n\
Usage: RAM_D.sh [-keep_index]\n\
