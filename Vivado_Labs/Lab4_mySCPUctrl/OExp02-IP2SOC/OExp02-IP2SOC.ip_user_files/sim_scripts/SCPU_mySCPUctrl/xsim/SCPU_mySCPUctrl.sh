...
#
# Script generated by Vivado on Thu Dec 05 18:45:29 +0800 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : SCPU_mySCPUctrl.sh
...
#
# Usage        : SCPU_mySCPUctrl.sh
#                SCPU_mySCPUctrl.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                SCPU_mySCPUctrl.sh [-reset_run]
#                SCPU_mySCPUctrl.sh [-reset_log]
#                SCPU_mySCPUctrl.sh [-help]
#
...
# script info
echo -e "SCPU_mySCPUctrl.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./SCPU_mySCPUctrl.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot SCPU_mySCPUctrl xil_defaultlib.SCPU_mySCPUctrl xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim SCPU_mySCPUctrl -key {Behavioral:sim_1:Functional:SCPU_mySCPUctrl} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb SCPU_mySCPUctrl.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./SCPU_mySCPUctrl.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: SCPU_mySCPUctrl.sh [-help]\n\
Usage: SCPU_mySCPUctrl.sh [-step]\n\
Usage: SCPU_mySCPUctrl.sh [-lib_map_path]\n\
Usage: SCPU_mySCPUctrl.sh [-reset_run]\n\
Usage: SCPU_mySCPUctrl.sh [-reset_log]\n\
Usage: SCPU_mySCPUctrl.sh [-keep_index]\n\
Usage: SCPU_mySCPUctrl.sh [-noclean_files]\n\n\
