...
#                script (type 'SCPU_mySCPUctrl.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.SCPU_mySCPUctrl xil_defaultlib.glbl -o SCPU_mySCPUctrl_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./SCPU_mySCPUctrl_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key SCPU_mySCPUctrl_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc SCPU_mySCPUctrl_simv.daidir vcs_lib c.obj)
