...
#
# Script generated by Vivado on Sun Dec 08 17:01:19 +0800 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : mySCPU_exp.sh
...
#
# Usage        : mySCPU_exp.sh
#                mySCPU_exp.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                mySCPU_exp.sh [-reset_run]
#                mySCPU_exp.sh [-reset_log]
#                mySCPU_exp.sh [-help]
#
...
# script info
echo -e "mySCPU_exp.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./mySCPU_exp.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot mySCPU_exp xil_defaultlib.mySCPU_exp xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim mySCPU_exp -key {Behavioral:sim_1:Functional:mySCPU_exp} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mySCPU_exp.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./mySCPU_exp.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: mySCPU_exp.sh [-help]\n\
Usage: mySCPU_exp.sh [-step]\n\
Usage: mySCPU_exp.sh [-lib_map_path]\n\
Usage: mySCPU_exp.sh [-reset_run]\n\
Usage: mySCPU_exp.sh [-reset_log]\n\
Usage: mySCPU_exp.sh [-keep_index]\n\
Usage: mySCPU_exp.sh [-noclean_files]\n\n\
